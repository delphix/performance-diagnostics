...
static void zvol_entry(zv_request_t *zvr, int op)
{
    zvol_data_t data = {};
...
int zvol_read_entry(struct pt_regs *ctx, zv_request_t *zvr)
{
...
int zvol_write_entry(struct pt_regs *ctx, zv_request_t *zvr)
{
...
int zvol_return(struct pt_regs *ctx)
{
    u32 pid = bpf_get_current_pid_tgid();
